import UserNavbar from "../../assets/img/user.png"

export const Navbar = () => {
    return (
        <header className="bg-white flex justify-center items-center h-16">
            <nav className="w-full flex justify-around items-center">
                ...
                <img src={UserNavbar} alt="imagen de perfil" className="w-12 h-12 rounded-full bg-black" loading="lazy" decoding="async" />
            </nav>
        </header>
    )
}
