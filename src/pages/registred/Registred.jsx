        ...
        <main className="flex flex-row justify-center items-center bg-white">
            <section className="w-[663px]">
                <div className="flex flex-col justify-center items-center gap-5">
                    ...
                    <p>Si no tienes cuenta puedes crearla ahora mismo y gratis !</p>
                    <form
                        action=""
                    ...
                    >
                        ...
                        <button
                            className="-mb-3 bg-[#6C3483] border w-[193px] rounded-md h-11 text-white font-bold flex justify-center items-center"
                        >Registrarse</button>
                        <GoogleLogin />
                        <p>
                            Ya tienes cuenta?
